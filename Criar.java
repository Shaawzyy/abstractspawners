...
public class Criar {
	...
	public static ItemStack adddata(Material m, String nome, int data) {
	...
	public static ItemStack addSpawner(Material m, String nome, int quantidade, String[] lore) {
		ItemStack item = new ItemStack(m, quantidade);
		ItemMeta meta = item.getItemMeta();
		meta.setLore(Arrays.asList(lore));
		meta.setDisplayName(nome);
	...
	public static ItemStack itemGlass(Material m, String nome, int data) {
		ItemStack item = new ItemStack(m, 1, (short) data);
		ItemMeta meta = item.getItemMeta();
		meta.setDisplayName(nome);
		item.setItemMeta(meta);
	...
	public static ItemStack itemEncantar(Material m, String nome, String lore1, Enchantment enchant, int lvl) {
		ItemStack item = new ItemStack(m);
	...
	public static ItemStack itemPoteSemEXP(Material m, String nome, String lore1, String lore2, String lore3) {
		ItemStack item = new ItemStack(m);
		ItemMeta meta = item.getItemMeta();
		ArrayList<String> itemLore = new ArrayList<>();
		itemLore.add(lore1);
	...
	public static ItemStack itemPote(Material m, String nome, String lore1) {
		ItemStack item = new ItemStack(m);
		ItemMeta meta = item.getItemMeta();
		ArrayList<String> itemLore = new ArrayList<>();
		itemLore.add(lore1);
	...
	public static ItemStack itemEncantar2(Material m, String nome, String lore1) {
		ItemStack item = new ItemStack(m);
		ItemMeta meta = item.getItemMeta();
		ArrayList<String> itemLore = new ArrayList<>();
		itemLore.add(lore1);
	...
	public static ItemStack add3Enc(Material m, Enchantment enchant1, int lvl1,
			Enchantment enchant2, int lvl2, Enchantment enchant3, int lvl3) {
		ItemStack item = new ItemStack(m);
		item.addUnsafeEnchantment(enchant1, lvl1);
		item.addUnsafeEnchantment(enchant2, lvl2);
